...
[![R-CMD-check](https://github.com/ChrispinChaguza/RCandy/workflows/R-CMD-check/badge.svg)](https://github.com/ChrispinChaguza/RCandy/actions)
<!-- badges: end -->
...
gubbins.gff <- system.file("extdata", "ST320.recombination_predictions.gff.gz", package = "RCandy", 
    mustWork = TRUE)
ref.genome.gff <- system.file("extdata", "Hungary19A-6.gff.gz", package = "RCandy", 
    mustWork = TRUE)
```
...
#> [1] tidyr_1.0.2  ape_5.3      RCandy_1.0.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] phangorn_2.5.5          shape_1.4.4             gtools_3.8.1           
#>  [4] tidyselect_1.1.0        xfun_0.20               purrr_0.3.3            
#>  [7] lattice_0.20-38         phytools_0.7-47         colorspace_1.4-1       
#> [10] vctrs_0.3.6             generics_0.0.2          expm_0.999-4           
#> [13] viridisLite_0.3.0       htmltools_0.5.1.1       yaml_2.2.1             
#> [16] rlang_0.4.10            pillar_1.4.3            glue_1.4.0             
#> [19] DBI_1.1.0               lifecycle_0.2.0         stringr_1.4.0          
#> [22] munsell_0.5.0           combinat_0.0-8          gtable_0.3.0           
#> [25] coda_0.19-3             evaluate_0.14           knitr_1.28             
#> [28] parallel_3.6.3          Rcpp_1.0.4.6            scales_1.1.0           
#> [31] formatR_1.7             plotrix_3.7-7           clusterGeneration_1.3.4
#> [34] scatterplot3d_0.3-41    gridExtra_2.3           fastmatch_1.1-0        
#> [37] mnormt_1.5-6            ggplot2_3.3.0           digest_0.6.25          
#> [40] stringi_1.4.6           animation_2.6           dplyr_1.0.3            
#> [43] numDeriv_2016.8-1.1     grid_3.6.3              quadprog_1.5-8         
#> [46] tools_3.6.3             magrittr_1.5            maps_3.3.0             
#> [49] tibble_2.1.3            crayon_1.3.4            pkgconfig_2.0.3        
#> [52] ellipsis_0.3.0          MASS_7.3-51.5           Matrix_1.2-18          
#> [55] rmarkdown_2.6           viridis_0.5.1           R6_2.4.1               
#> [58] igraph_1.2.5            nlme_3.1-144            compiler_3.6.3
```
